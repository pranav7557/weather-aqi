...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get(
            "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=710328B7-D5AC-4DE1-81E8-F3523DFFF441")
        try:
        ...
        api_request = requests.get(
            "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=25&API_KEY=710328B7-D5AC-4DE1-81E8-F3523DFFF441")
        try:
            api = json.loads(api_request.content)
        except Exception as e:
            api = "Error..."
